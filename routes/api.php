...
use App\Http\Controllers\Media\ChannelController;
...
Route::post('/loginTowFa',      [TwoFactorAuthController::class, 'TowFALogin']);
Route::post('/verifyCodeTowFa',    [TwoFactorAuthController::class, 'Loginverify']);
...
Route::middleware('auth:sanctum')->post('/channels/{id}/subscribe', [ChannelController::class, 'subscribe']);
Route::get('/channels/{id}', [ChannelController::class, 'showChannel']);
